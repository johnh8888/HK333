...
def main():
    ...
    calib_seq = seq[-test_len-50:-test_len]
    ...
    for i in range(len(calib_seq)-1):
        ...
        cal_labels.append(1.0)  # 标签恒为1，因为我们要校准“真实类别概率”的置信度
    ...
    with open('tuning_report.txt', 'w', encoding='utf-8') as f:
        ...
        f.write(f"校准集 ECE: {best_ece:.4f}\n")
        f.write(f"测试集 ECE: {ece_final:.4f}\n")
